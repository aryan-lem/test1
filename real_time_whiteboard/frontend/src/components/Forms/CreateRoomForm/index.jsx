        ...
        <form className="form col-md-12 mt-5">
            ...
            <div className="form-group border">
                <div className="input-group d-flex align-items-center justify-content-center">
                    <input type="text" className="form-control my-2" value={roomId} disabled placeholder="Generate Room Code"/>
                    <div className="input-group-append ">
                        <button className="btn btn-primary btn-sm me-1 ms-2" type="button" onClick={()=>setRoomId(uuid())}>
                            Generate
                        </button>
